...
class HomePage extends Component {
  ...
  render() {
    ...
    return (
      <div className="chaabi-Container">
        <div className="chaabiAndTimerContainer">
          <h1 className="mainHeading">Touch Typing</h1>
          <div className="timerContainer">
            {minutes === 0 && seconds === 0 ? (
              <h1 className="chaabiTextCSS">Time Out!</h1>
            ) : (
              <h1 className="chaabiTextCSS">
